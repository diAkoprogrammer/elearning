...
<script>
	$(document).ready(function(){
		$('.new_academic').click(function(){
			uni_modal("New School Year","./academic/manage_sy.php")
		})
		$('.action_edit').click(function(){
			uni_modal("Edit School Year","./academic/manage_sy.php?id="+$(this).attr('data-id'));
		})
		$('.action_delete').click(function(){
		_conf("Are you sure to delete School Year?","delete_academic",[$(this).attr('data-id')])
		})
		$('table').dataTable();
	})
